    ...
    def __init__(self,canvas,tag,bg="#ffffff",needlecolor="#0d47a1",markscolor="#000000",Range=(0,30),digitscolor="#ff2222"):
        ...
        for i in range(-10,195,20):
            if(i%10==0):
                ...
                self.range_marks.append(canvas.create_text(x1+u,y1+q,text=int((i+10)*(self.range[1]-self.range[0]-20)/300+self.range[0]),font=("Courier",int(self.radius/10)),fill=digitscolor))
            else:
                #In between markings
